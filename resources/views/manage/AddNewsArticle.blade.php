            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="container">
                        ...
                        <form id="add-form" enctype="multipart/form-data" action="/newsarticles" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                @foreach ($articleCategories as $articleCategory)
                                    ...
                                    <label class="mr-3" for="category-radio-{{ $counter }}">
                                        {{ $articleCategory->category }}</label>
                                @endforeach
                            </div>
                            <div class="form-group">
                                <label for="usr" hidden>author_name:</label>
                                <input hidden type="text" name="author_name"
                                    class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline">
                            </div>
                            <div class="form-group">
                                ...
                                <textarea required id="mytextarea" hidden name="content"
                                    class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline">
            </textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input hidden type="text" name="date_publish"
                                    class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline">
                            </div>
