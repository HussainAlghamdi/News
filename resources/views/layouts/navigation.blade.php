...
<nav class="flex justify-between bg-custom1 text-white px-3 py-3 items-center title-font">
    <div class="flex">
        ...
        {{-- <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
            <x-nav-link :href="route('view2')" :active="request()->routeIs('view2')">
                {{ __('Articles') }}
            </x-nav-link>
        </div> --}}
    ...
    <!-- Settings Dropdown -->
    <div class="hidden sm:flex sm:items-center sm:ml-6" style="font-family: 'Arvo', serif;">
        <x-dropdown align="right" width="48">
            <x-slot name="trigger">
                <button
                    class="flex items-center text-sm font-medium text-white-500 hover:text-white-700 hover:border-white-300 focus:outline-none focus:text-white-700 focus:border-white-300 transition duration-150 ease-in-out">
