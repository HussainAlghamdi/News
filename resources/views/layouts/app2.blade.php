        ...
        <div class="flex items-center justify-between mx-auto max-w-7xl">
            <div class="flex items-center space-x-3">
                ...
                <div class="inline-flex md:hidden" x-data="{ open: false }">
                    ...
                    <div class="absolute top-0 left-0 right-0 z-50 flex flex-col p-2 m-2 space-y-2 bg-custom1 rounded shadow"
                        ...
                        <a class="btn btn-sm btn-icon nav-btn" href="/newsarticles/allnews">
                        ...
                        <a class="btn btn-sm btn-icon nav-btn" href="/newsarticles/advanceSearch">
            ...
            <div class="hidden space-x-1 md:inline-flex" style="font-family: 'Arvo', serif;">
                ...
                <a class="linkNav btn btn-sm btn-icon nav-btn" href="/newsarticles/allnews">
                    <i class="mr-2 far fa-newspaper"></i>
                    News
                </a>
                ...
                <a class="linkNav btn btn-sm btn-icon nav-btn" href="/newsarticles/advanceSearch">
                    <i class="mr-2 fas fa-search"></i>
                    Advance Search
                </a>
            ...
            <div class="search-section">
                ...
                <form action="/newsarticles/search" method="GET" class="form-inline my-2 my-lg-0">
                    <div class="relative text-gray-600 focus-within:text-gray-400">
                        ...
                        <input type="search" name="query"
                            class="py-2 text-sma bg-gray-100 rounded-md pl-10 focus:outline-none focus:bg-white focus:text-gray-900"
